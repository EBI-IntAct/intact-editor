...
public class MiExportServiceImpl implements MiExportService {
    ...
    private PublicationEditorService publicationEditorService;
    ...
    public Object exportPublicationFromImexId(String imexId, String format) {
        ...
        try {
            ...
            //language=JPAQL
            final String query = "select distinct i from IntactInteractionEvidence i join i.dbExperiments as e join e.publication as p join p.dbXrefs as pXref join pXref.qualifier as qualifier " +
                    "where qualifier.shortName = :qualifier and pXref.id = :imexId";

            //language=JPAQL
            final String countQuery = "select count(distinct i.ac) from IntactInteractionEvidence i join i.dbExperiments as e join e.publication as p join p.dbXrefs as pXref join pXref.qualifier as qualifier " +
                    "where qualifier.shortName = :qualifier and pXref.id = :imexId";
