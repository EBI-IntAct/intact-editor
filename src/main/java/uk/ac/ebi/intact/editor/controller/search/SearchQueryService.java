...
public class SearchQueryService extends JpaAwareController {
    ...
    public void searchIfQueryPresent() {
    ...
    public void searchJamiIfQueryPresent() {
        if (query != null && !query.isEmpty()) {
            doJamiSearch();
        }
    }
    ...
    @Transactional(value = "jamiTransactionManager", readOnly = true, propagation = Propagation.REQUIRED)
    public String doQuickJamiSearch() {
        this.query = quickQuery;
        return doJamiSearch();
    }
