...
public class BatchJobService {
    ...
    private static final String SQL_DELETE_BATCH_JOB_INSTANCE = "DELETE FROM BATCH_JOB_INSTANCE WHERE NOT EXISTS (SELECT * FROM BATCH_JOB_EXECUTION WHERE BATCH_JOB_EXECUTION.JOB_INSTANCE_ID = BATCH_JOB_INSTANCE.JOB_INSTANCE_ID)";
